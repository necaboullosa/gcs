            ...
            <!-- END The Team -->
             ...
             <?php if(get_sub_field('section_header')) { ?><h2 class="section-header sm-red-line"> <?php the_sub_field('section_header'); ?> </h2><?php } ?>
                <div class="the-loop">
                    ...
                    <?php echo apply_filters( 'the_content', '[ajax_load_more container_type="div" posts_per_page="6" css_classes="the-loop" post_type="post" category="cyprus-news,guides,malta-news,market-outlook,portugal-news,property-market,spain-news,united-kingdom-news" offset="6" pause="true" scroll="false" button_label="Older Entries"]'); ?>
            <!-- END Blog posts loop -->
